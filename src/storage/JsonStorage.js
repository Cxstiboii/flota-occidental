...
class JsonStorage extends StorageAdapter {
  ...
  _normalizeUser(userId, userData = {}) {
    return {
      ...
      totalCarreras: Number(userData.totalCarreras ?? userData.carreras ?? 0),
      totalEncargos: Number(userData.totalEncargos ?? userData.encargos ?? 0),
      totalGanado: Number(userData.totalGanado ?? userData.dineroTotal ?? 0),
